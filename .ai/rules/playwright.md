...
- To run playwright tests, you need to setup dependencies, it is implemented in the "npm run test:e2e" from "./frontend" dir. It is not possible to directly run "npx playwright" command
