...
export class AddDateProperties1777492642463 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "fap_analysis" ALTER COLUMN "file_name" TYPE character varying(255)`);
        ...
        await queryRunner.query(`ALTER TABLE "fap_analysis" ALTER COLUMN "message" TYPE character varying(255)`);
        await queryRunner.query(`ALTER TABLE "fap_analysis" ALTER COLUMN "version" TYPE character varying(255)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "fap_analysis" ALTER COLUMN "version" TYPE character varying`);
        await queryRunner.query(`ALTER TABLE "fap_analysis" ALTER COLUMN "message" TYPE character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "fap_analysis" ALTER COLUMN "file_name" TYPE character varying`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "password_hash" TYPE character varying`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3"`);
